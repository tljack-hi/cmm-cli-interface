...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            "Usage: listtransactions ( \"account\" count from includeWatchonly)\n"
            "\n"
            ...
            "  {\n"
            "    \"account\": \"\",\n"
            "    \"address\": \"CW6FnTe7JPT85bSxJ2gaAKBUTKvhe8iEdQ\",\n"
            "    \"category\": \"immature\",\n"
            "    \"amount\": 1.80000000,\n"
            "    \"vout\": 0,\n"
            "    \"confirmations\": 28,\n"
            "    \"generated\": true,\n"
            "    \"blockhash\": \"0000006f33d457144105e27b258637fabc429952c90c3d936caf1e5b9780f710\",\n"
            "    \"blockindex\": 0,\n"
            "    \"blocktime\": 1610749902,\n"
            "    \"expiryheight\": 0,\n"
            "    \"txid\": \"1304e5ba536e2293a2ce8281d1900d6e7a60497445b8ade6ca3d684f3033bfb4\",\n"
            "    \"walletconflicts\": [\n"
            "    ],\n"
            "    \"time\": 1610749902,\n"
            "    \"timereceived\": 1610749954,\n"
            "    \"vjoinsplit\": [\n"
            "    ],\n"
            "    \"size\": 197\n"
            "  },\n"
           ...
           "[\n"
            "  {\n"
            "    \"account\": \"\",\n"
            "    \"address\": \"CH3GP1YZzWja38oMhPA2RRDa2fGxT1U49F\",\n"
            "    \"category\": \"generate\",\n"
            "    \"amount\": 1.80000000,\n"
            "    \"vout\": 1,\n"
            "    \"confirmations\": 240,\n"
            "    \"generated\": true,\n"
            "    \"blockhash\": \"00000028639d430dbfdbaf6290634338d87ec582d25a61c83b5d42fde95ac48f\",\n"
            "    \"blockindex\": 0,\n"
            "    \"blocktime\": 1608312994,\n"
            "    \"expiryheight\": 0,\n"
            "    \"txid\": \"4c858d4b616b930e72e349d3ec6b4885e146580f944dd9c818954db9f7bd1dc1\",\n"
            "    \"walletconflicts\": [\n"
            "    ],\n"
            "    \"time\": 1608312994,\n"
            "    \"timereceived\": 1608313020,\n"
            "    \"vjoinsplit\": [\n"
            "    ],\n"
            "    \"size\": 197\n"
            "  },\n"
            ...
            "]\n"
            "\n"
            "List transactions 100 to 120 as a json rpc call\n"
            ...
            "    {\n"
            "      \"account\": \"\",\n"
            "      \"address\": \"CQPQH4xfpX24WPE77pzrrCL1EZJtndNTj5\",\n"
            "      \"category\": \"generate\",\n"
            "      \"amount\": 1.8,\n"
            "      \"vout\": 0,\n"
            "      \"confirmations\": 269,\n"
            "      \"generated\": true,\n"
            "      \"blockhash\": \"000000ebfde54328a2326b6c942d239622fdd382e9cb217f70470be3bed82778\",\n"
            "      \"blockindex\": 0,\n"
            "      \"blocktime\": 1610735842,\n"
            "      \"expiryheight\": 0,\n"
            "      \"txid\": \"df2c01164b96cc30d308b1fb0649f62aaf74f7fc7370345046cb5e7006a4c73e\",\n"
            "      \"walletconflicts\": [],\n"
            "      \"time\": 1610735842,\n"
            "      \"timereceived\": 1610735866,\n"
            "      \"vjoinsplit\": [],\n"
            "      \"size\": 197\n"
            "    },\n"
            "    ...\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("gettransaction", "\"244ea6209284ae6ae65d3e69e02ee695d2efe614e62b56fa468fe23ec07689ff\"")
            +
            "{\n"
            "  \"amount\": 1.80000000,\n"
            "  \"confirmations\": 32004,\n"
            "  \"generated\": true,\n"
            "  \"blockhash\": \"0000010c1e740d86910d4fb495bec51c88d19a04d88e9134d95e46649b1726f9\",\n"
            "  \"blockindex\": 0,\n"
            "  \"blocktime\": 1608308955,\n"
            "  \"expiryheight\": 0,\n"
            "  \"txid\": \"244ea6209284ae6ae65d3e69e02ee695d2efe614e62b56fa468fe23ec07689ff\",\n"
            "  \"walletconflicts\": [\n"
            "  ],\n"
            "  \"time\": 1608308955,\n"
            "  \"timereceived\": 1608308994,\n"
            "  \"vjoinsplit\": [\n"
            "  ],\n"
            "  \"details\": [\n"
            "    {\n"
            ...
            "    }\n"
            "  ],\n"
            "  \"hex\": \"\"\n"
            "}\n"
            "\n"
            + HelpExampleRpc("gettransaction", "\"244ea6209284ae6ae65d3e69e02ee695d2efe614e62b56fa468fe23ec07689ff\"")
            +
            "{\n"
            "  \"result\": {\n"
            "    \"amount\": 1.8,\n"
...
UniValue backupwallet(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\n"
            "If exportdir is not set then you will receive the error:\n"
            "  Cannot backup wallet until the -exportdir option has been set\n"
            "\n"
            "There are two ways to fix this:\n"
            "  1) Restart commerciumd as \"commerciumd -exportdir=/home/myusername/mydirectory\"\n"
            "  2) Edit commercium.conf to set exportdir to the directory you want to hold the wallet backups:\n"
            "       exportdir=/home/myusername/mydirectory\n"
            "     Save and then restart commerciumd\n"
            "\n"
            "Arguments:\n"
